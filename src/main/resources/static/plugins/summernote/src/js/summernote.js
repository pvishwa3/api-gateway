      ...
      context.memo('button.color', function () {
        return ui.buttonGroup({
          ...
          children: [
            ...
            ui.dropdown({
              items: [
                '<li class="row d-flex justify-content-between" style="margin-left: 10px;margin-right: 10px;width:450px;"> ',
                '<div class="">',
                '  <p class="note-palette-title">' + lang.color.background + '</p>',
                ...
                '</div>',
                '<div class="">',
                '  <p class="note-palette-title">' + lang.color.foreground + '</p>',
                '  <div style="display:none">',
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      icons: {
          ...
          'pencil': 'fa fa-pencil',
          'picture': 'fa fa-file-picture-o',
          'question': 'fa fa-question',
          'redo': 'fa fa-undo fa-flip-horizontal',
