...
'use strict';
app.service('chartTreeMapService', function ($state, $window) {
                ...
                label: {
                    normal: {
                        ...
                        formatter: function (a) {
    						...
    						var formatterType = cols[0].c_type;


    						if(formatterType && formatterType==='size'){
    							
    							return a.name + "\n\nvalue : " + formatBytes(parseInt(a.value));
    						}
