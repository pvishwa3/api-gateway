...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:    '<button type="submit" class="btn btn-link"><i class="fa fa-check"></i></button>',
      cancelTpl:    '<button type="button" class="btn btn-link" ng-click="$form.$cancel()"><i class="fa fa-close"></i></button>',
    ...
    'bs2': {
      ...
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="btn"><span></span></button>',
    ...
    'bs3': {
      ...
      controlsTpl: '<div class="" ng-class="{\'has-error\': $error}"></div>',
      inputTpl:    '',
      errorTpl:    '<div class="editable-error help-block" data-ng-if="$error" data-ng-bind-html="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="btn1"><span></span></button>',
      cancelTpl:   '<button type="button" class="btn1" ng-click="$form.$cancel()">'+
                     '<span></span>'+
                   '</button>',
      resetTpl:    '<button type="reset" class="btn btn-danger">clear</button>',
