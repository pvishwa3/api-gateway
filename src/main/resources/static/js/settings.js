app.controller("settings", ['$scope', 'settingsFactory','$rootScope','$timeout','$location','$uibModal','$sce','$window', '$sessionStorage',function ($scope, settingsFactory,$rootScope, $timeout,$location,$uibModal,$sce,$window,$sessionStorage) {
	...
	$scope.refreshFields = function(){
		...
		window.location.href = "/configuration#!/management";
	...
	$scope.updatePassword = function(){
		...
		$scope.userSettings.userName = $scope.UserName;
	...
	self.settings = {};
	self.saveHomePageSetting = function(){
		settingsFactory.saveHomePageSetting(self.settings).then(function(response){
			if(response.data.status){
...
//		settingsFactory.getSavedSettings().then(function(response){
//			self.settings = angular.copy(response.data);
//		});
//	}
