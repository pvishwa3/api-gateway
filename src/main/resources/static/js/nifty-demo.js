...
$(document).on('nifty.ready', function () {
	...
	if(sessionStorage.getItem("navigationType")){
		if(sessionStorage.getItem("navigationType")=== 'vertical'){

			$(".tgl-menu-btn").show();
			$(".horizontal-menu-layout").hide();
			$("#container").addClass("effect aside-float aside-bright mainnav-lg");


		}else{
			$(".tgl-menu-btn").hide();
			$(".horizontal-menu-layout").show();
			$("#container").addClass("effect aside-float aside-bright push mainnav-out");
		}
	}else{
		$(".tgl-menu-btn").hide();
		$(".horizontal-menu-layout").show();
	...
	$('#toogle-theme').one('click', function(){
	...
	var settingsInit = function(){
		...
		$("#horizontal-menu").on('click',function(){
			$(".tgl-menu-btn").hide();
			$(".horizontal-menu-layout").show();
			$("#container").removeAttr('class')
			$("#container").addClass("effect aside-float aside-bright push mainnav-out");
			sessionStorage.setItem("navigationType", "horizontal");
		...
		$("#vertical-menu").on('click',function(){
			...
			$("#container").removeAttr('class')
			$("#container").addClass("effect aside-float aside-bright mainnav-lg");
			sessionStorage.setItem("navigationType", "vertical");
		});
		...
		changeTheme = function (themeName, type) {
			...
			sessionStorage.setItem("themeType", themeName);

			var themeCSS = $('#theme'),
			fileext = '.css',
			filename = 'assets/css/themes/type-' + type + '/' + themeName + fileext;
			...
			if(type==="full" && themeName==="theme-dark-full"){
				location.reload();
			}
	...
	function changeThemeOnLoad(){
		if(sessionStorage.getItem("themeType")==='theme-dark-full'){
			changeTheme("theme-dark-full","full");
		}
	}
